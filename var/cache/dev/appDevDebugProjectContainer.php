...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'test_article.tva.17' => 'getTestArticle_Tva_17Service',
            'test_article.tva.3' => 'getTestArticle_Tva_3Service',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('TTMe4G4pgb', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JnkIkSxBTF', '', '06b0phBOfStwkpvSBLRHSQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fiSp6Sz1Ix', '', '06b0phBOfStwkpvSBLRHSQ', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kLSVWRkzhH', '', '06b0phBOfStwkpvSBLRHSQ', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist'), $this->get('test_article.tva.3'));
        $c->addEventListener(array(0 => 'prePersist'), $this->get('test_article.tva.17'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'testarticle', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Test\\ArticleBundle\\Entity'))), 'Test\\ArticleBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TestArticleBundle' => 'Test\\ArticleBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ea8ec79194a9a03494722908b66e96b2bf54d62b70086f9d734de2873f09e55a');
    ...
    /**
     * Gets the 'test_article.tva.17' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Test\ArticleBundle\Tva\Tva A Test\ArticleBundle\Tva\Tva instance.
     */
    protected function getTestArticle_Tva_17Service()
    {
        return $this->services['test_article.tva.17'] = new \Test\ArticleBundle\Tva\Tva(1.1699999999999999);
    }

    /**
     * Gets the 'test_article.tva.3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Test\ArticleBundle\Tva\Tva A Test\ArticleBundle\Tva\Tva instance.
     */
    protected function getTestArticle_Tva_3Service()
    {
        return $this->services['test_article.tva.3'] = new \Test\ArticleBundle\Tva\Tva(1.03);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Test\\ArticleBundle/Resources/views'), 'TestArticle');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('939a55389ee63f9e3a8b9080331973ec9399fa79');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a273160acc852.20686099')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TestArticleBundle' => 'Test\\ArticleBundle\\TestArticleBundle',
            ...
            'secret' => '939a55389ee63f9e3a8b9080331973ec9399fa79',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '939a55389ee63f9e3a8b9080331973ec9399fa79',
